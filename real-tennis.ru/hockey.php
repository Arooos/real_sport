...
<head>
    ...
    <link rel="shortcut icon" href="icons/hockey/hockey.ico">
...
<body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-0 col-md-5 offset-md-0 col-sm-6 offset-sm-3">
                    ...
                    <div class="promo_descr">Серия любительских<br>хоккейных матчей<br>в Санкт-Петербурге</div>
                    <div class="social">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="main">
                            ...
                            ?>
                        <div class="front">
                            <img src="img/hockey/categories/man1.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">ХОККЕЙ<br>С ШАЙБОЙ</div>
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">ХОККЕЙ<br>С ШАЙБОЙ</div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="main">
                                ...
                                ?>
                        <div class="front">
                            <img src="img/hockey/categories/man2.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">ХОККЕЙ<br>С МЯЧОМ</div>
                                <div class="categories_front_inf">ДАТЫ:</div>
                                <div class="categories_front_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">ХОККЕЙ<br>С МЯЧОМ</div>
                                <div class="categories_back_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
                ...
                <div class="col-md-4">
                    ...
                    <div class="main">
                            ...
                            ?>
                        <div class="front">
                            <img src="img/hockey/categories/woman2.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">ХОККЕЙ<br>НА ТРАВЕ</div>
                                <div class="categories_front_inf">ДАТЫ:</div>
                                <div class="categories_front_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">ХОККЕЙ<br>НА ТРАВЕ</div>
                                <div class="categories_back_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
        ...
        <div class="container">
            <div class="wrapper">
                <div class="item">
                    ...
                    <div class="main">
                        <?php
                            //выбока самой поздней записи из турниров где категория МУЖСКАЯ ОДИНОЧКА id=1
                            $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 1);");
                            $opt->execute(array());
                            $value = $opt->fetchall(PDO::FETCH_ASSOC);
                            foreach($value as $val){
                        ?>
                        <div class="front">
                            <img src="img/hockey/categories/man2.png" alt="" class="front_item_img">
                            
                            <div class="front_item">
                                <div class="front_item_title">ХОККЕЙ<br>С ШАЙБОЙ</div>
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">ХОККЕЙ<br>С ШАЙБОЙ</div>
                    ...
                    <div class="main">
                        <div class="front">
                            <img src="img/hockey/categories/man1.png" alt="" class="front_item_img">
                            <div class="front_item">
                                <div class="front_item_title">ХОККЕЙ<br>С ШАЙБОЙ</div>
                                <div class="front_item_inf">ДАТЫ:</div>
                ...
                <div class="item">
                    ...
                    <div class="main">
                        ...
                        <div class="front">
                            ...
                            <div class="front_item">
                                <div class="front_item_title">ХОККЕЙ<br>С МЯЧОМ</div>
                                <div class="front_item_inf">ДАТЫ:</div>
                                <div class="front_item_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">ХОККЕЙ<br>С МЯЧОМ</div>
                                <div class="back_item_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
                ...
                <div class="item">
                    ...
                    <div class="main">
                        ...
                        ?>
                        <div class="front">
                            <img src="img/hockey/categories/woman2.png" alt="" class="front_item_img">
                            <div class="front_item">
                                <div class="front_item_title">ХОККЕЙ<br>НА ТРАВЕ</div>
                                <div class="front_item_inf">ДАТЫ:</div>
                                <div class="front_item_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">ХОККЕЙ<br>НА ТРАВЕ</div>
                                <div class="back_item_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
        ...
        <div class="carousel">
            <div class="container">
                ...
                <div class="carousel__inner">
                    <div>
                        <img src="img/hockey/courts/sestr2.png" alt="">
                    ...
                    <div>
                        <img src="img/hockey/courts/sestr.png" alt="">
                    ...
                    <div>
                        <img src="img/hockey/courts/energy.png" alt="">
                    ...
                    <div>
                        <img src="img/hockey/courts/lisiy.png" alt="">
    ...
    <section class="history" id="history">
        <div class="title">ИСТОРИЯ МАТЧЕЙ</div>
            <div class="container">
                <div class="slider">
            ...
            <div class="modal_footer">
                <div class="row">
                    ...
                    <div class="col-md-6 modal_social">
                        <a href=""><img src="icons/hockey/teleg.svg" alt=""></a>
                        <a href=""><img src="icons/hockey/VK.svg" alt=""></a>
                        <a href=""><img src="icons/hockey/ok.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="#promo" class="pageup">
        <img src="icons/hockey/up_hockey.svg" alt="up" >
    </a>
