...
$sql = "INSERT INTO `tournament` (`id`, `id_categories`, `id_address`, `id_place`, `date`, `time`, `price`, `id_class`, `id_organizer`, `year`) VALUES (NULL, '$cat_val', '$pls_val', '$add_val', '$data', '$time', NULL, '$cls_val', '$org_val', '$year')";
$query = $db->exec($sql);?>
