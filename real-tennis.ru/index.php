...
<head>
    ...
    <link rel="icon" href="icons/basketball/favicon.ico">
...
<body class="body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-0 col-md-5 offset-md-0 col-sm-6 offset-sm-3">
                    ...
                    <div class="promo_descr">Серия любительских<br>баскетбольных матчей<br>в Санкт-Петербурге</div>
                    <div class="social">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <?php 
                        $opt = $db->prepare("SELECT `date` FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 1)");
                        $opt->execute(array());
                    ...
                    <div class="main">
                            <?php
                                ...
                                $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 1);");
                                $opt->execute(array());
                                $value = $opt->fetchall(PDO::FETCH_ASSOC);
                                foreach($value as $val){
                            ?>
                        <div class="front">
                            <img src="img/basketball/categories/man1.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">уличный<br>баскетбол</div>
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">уличный<br>баскетбол</div>
                ...
                <div class="col-md-4">
                    <!-- цикл для вывода актуальных турниров ( которые не актуальной/сегодняшней даты) -->
                    <?php 
                        $opt = $db->prepare("SELECT `date` FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 2)");
                        $opt->execute(array());
                        $date_tour = $opt->fetch(PDO::FETCH_COLUMN);
                        if ($date_now < $date_tour):
                    ?>
                    <div class="main">
                                <?php
                                    ...
                                    $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 2);");
                                    $opt->execute(array());
                                    $value = $opt->fetchall(PDO::FETCH_ASSOC);
                                    foreach($value as $val){
                                ?>
                        <div class="front">
                            <img src="img/basketball/categories/man2.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">традиционный<br>баскетбол</div>
                                <div class="categories_front_inf">ДАТЫ:</div>
                                <div class="categories_front_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                    ...
                    <div class="main">
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">традиционный<br>баскетбол</div>
                                <div class="categories_back_address">ИНФОРМАЦИЯ СКОРО ПОЯВИТСЯ</div>
                                <div class="categories_back_near_else">СКОРО</div>
                                <div class="categories_back_data">РЕГЛАМЕНТ: <span>УТОЧНЯЕТСЯ</span></div>
                            </div>
                ...
                <div class="col-md-4">
                        <!-- цикл для вывода актуальных турниров ( которые не актуальной/сегодняшней даты) -->
                        <?php 
                            $opt = $db->prepare("SELECT `date` FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 3)");
                            $opt->execute(array());
                            $date_tour = $opt->fetch(PDO::FETCH_COLUMN);
                            if ($date_now < $date_tour):
                        ?>
                    <div class="main">
                            <?php
                                ...
                                $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 3);");
                                $opt->execute(array());
                                $value = $opt->fetchall(PDO::FETCH_ASSOC);
                                foreach($value as $val){
                            ?>
                        <div class="front">
                            <img src="img/basketball/categories/woman2.png" alt="" class="categories_front_img">
                            <div class="categories_front">
                                <div class="categories_front_title">американский<br>баскетбол</div>
                                <div class="categories_front_inf">ДАТЫ:</div>
                                <div class="categories_front_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="categories_back">
                                <div class="categories_back_title">американский<br>баскетбол</div>
                                <div class="categories_back_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
            ...
            <div class="wrapper">
                <div class="item">
                    ...
                    <div class="main">
                        ...
                        ?>
                        <div class="front">
                            <img src="img/basketball/categories/man1.png" alt="" class="front_item_img">
                            
                            <div class="front_item">
                                <div class="front_item_title">уличный<br>баскетбол</div>
                                ...
                                <?php
                                    ...
                                    $value = $opt->fetchall(PDO::FETCH_ASSOC);
                                    foreach ($value as $result_row){
                                        echo $result_row["surname"],' ',$result_row["name"]?><br><?php echo $result_row["patronymic"];
                                    }?>
                                </div>
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">уличный<br>баскетбол</div>
                ...
                <div class="item">
                    ...
                    <div class="main">
                        <?php
                            //выбока самой поздней записи из турниров где категория МУЖСКАЯ ПАРА id=2
                            $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 2);");
                            $opt->execute(array());
                            $value = $opt->fetchall(PDO::FETCH_ASSOC);
                            foreach($value as $val){
                        ?>
                        <div class="front">
                            <img src="img/basketball/categories/man2.png" alt="" class="front_item_img">
                            
                            <div class="front_item">
                                <div class="front_item_title">традиционный<br>баскетбол</div>
                                <div class="front_item_inf">ДАТЫ:</div>
                                <div class="front_item_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">традиционный<br>баскетбол</div>
                                <div class="back_item_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
                ...
                <div class="item">
                    ...
                    <div class="main">
                        <?php
                            //выбока самой поздней записи из турниров где категория МУЖСКАЯ ОДИНОЧКА id=3
                            $opt = $db->prepare("SELECT * FROM `tournament` WHERE ID = (SELECT MAX(ID) FROM `tournament` WHERE id_categories = 3);");
                            $opt->execute(array());
                            $value = $opt->fetchall(PDO::FETCH_ASSOC);
                            foreach($value as $val){
                        ?>
                        <div class="front">
                            <img src="img/basketball/categories/woman2.png" alt="" class="front_item_img">
                            <div class="front_item">
                                <div class="front_item_title">американский<br>баскетбол</div>
                                <div class="front_item_inf">ДАТЫ:</div>
                                <div class="front_item_near">
                                <?php
                                    $class = $db->prepare("SELECT MONTH(`date`) FROM `tournament` WHERE id=$val[id]");
                        ...
                        <div class="back">
                            <div class="back_item">
                                <div class="back_item_title">американский<br>баскетбол</div>
                                <div class="back_item_address">
                                <!-- вывод места -->
                                <?php
                                    $dt = $val["id_place"];
        ...
        <div class="carousel">
            <div class="container">
                ...
                <div class="carousel__inner">
                    <div>
                        <img src="img/basketball/courts/sestr.png" alt="">
                    ...
                    <div>
                        <img src="img/basketball/courts/sestr2.png" alt="">
                    ...
                    <div>
                        <img src="img/basketball/courts/energy.png" alt="">
                    ...
                    <div>
                        <img src="img/basketball/courts/lisiy.png" alt="">
                ...
                <div class="slider">
                    <div class="slider-block">
                        <div class="slider-wrapper">
                            <button data-modal="modal_tour" class="slider-wrapper-item orange bg_block" id="2019">2019</button>
                        </div>
                    </div>
                    <div class="slider-block">
                        <div class="slider-wrapper">
                    ...
                    <div class="slider-block">
                        <div class="slider-wrapper">
                            <button data-modal="modal_tour" class="slider-wrapper-item red bg_block" id="2021">2021</button>
                        </div>
                    </div>
                    <div class="slider-block">
                        <div class="slider-wrapper">
                            <button data-modal="modal_tour" class="slider-wrapper-item orange bg_block" id="2022">2022</button>
                        </div>
                    </div>
                    <div class="slider-block">
                        <div class="slider-wrapper">
   ...
   <section class="history_sm" id="history_sm">
        ...
        <div class="container">       
            <div class="wrap">
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn orange bg_block" id="2019">2019</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn braun bg_block" id="2020">2020</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn red bg_block" id="2021">2021</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn orange bg_block" id="2022">2022</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn braun bg_block" id="2023">2023</button>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="modal_footer">
                <div class="row">
                    ...
                    <div class="col-md-6 modal_social">
                        <a href=""><img src="icons/basketball/teleg.svg" alt=""></a>
                        <a href=""><img src="icons/basketball/VK.svg" alt=""></a>
                        <a href=""><img src="icons/basketball/ok.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <a href="#promo" class="pageup">
        <img src="icons/basketball/up_basketball.svg" alt="up" >
    </a>
