			...
			<div class="row">
				<div class="col-md-8">
					<ul class="menu">
						...
						<li><a href="#courts" class="menu_link">площадки</a></li>
					...
					<ul class="menu_sm">
						...
						<li><a href="#courts" class="menu_sm_link">площадки</a></li>
				...
				<div class="col-lg-3 offset-lg-1 col-md-3 offset-md-1 col-sm-5 offset-sm-7 col-6 offset-6">
					<?php
						switch($case){
						case 1: ?>
						<ul>
							<li><a class="active" href="index.php">баскетбол</a>
								<ul>
						...
						<ul>
							<li><a class="active" href="hockey.php">хоккей</a>
								<ul>
									<li><a href="index.php">баскетбол</a></li>
									<li><a href="ski.php">лыжи</a></li>
									<li><a href="tennis.php">теннис</a></li>
								</ul>
							</li>
