...
<body class="body">
    ...
    <section class="history_sm" id="history_sm">
        ...
        <div class="container">       
            <div class="wrap">
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn orange bg_block" id="2024">2024</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn braun bg_block" id="2023">2023</button>
                </div>
                <div class="it">
                    <button data-modal="modal_tour" class="it_btn red bg_block" id="2022">2022</button>
                </div>
                <div class="it">
            ...
            <div class="modal_footer">
                <div class="row">
                    ...
                    <div class="col-md-6 modal_social">
                        <a href=""><img src="icons/basketball/inst.svg" alt=""></a>
                        <a href=""><img src="icons/basketball/teleg.svg" alt=""></a>
                        <a href=""><img src="icons/basketball/whats.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
