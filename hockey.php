        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <?php 
                        $opt = $db->prepare("SELECT * FROM `tournament` WHERE date = (SELECT MIN(date) from tournament WHERE date >= CURRENT_DATE);");                        // ("SELECT * FROM `tournament` WHERE date = (SELECT MIN(date) from tournament WHERE date > CURRENT_DATE);")
                        $opt->execute(array());
