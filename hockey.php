        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <?php 
                        $opt = $db->prepare("SELECT `date` FROM `tournament` WHERE date = (SELECT MIN(date) from tournament WHERE date >= CURRENT_DATE) and id_categories = 1;");                        // ("SELECT * FROM `tournament` WHERE date = (SELECT MIN(date) from tournament WHERE date > CURRENT_DATE);")
                        $opt->execute(array());
                ...
                <div class="col-md-4">
                    ...
                    <div class="main">
                                <?php
                                    //выбока самой поздней записи из турниров где категория МУЖСКАЯ ОДИНОЧКА id=2
            ...
            <div class="modal_footer">
                <div class="row">
                    ...
                    <div class="col-md-6 modal_social">
                        <a href=""><img src="icons/hockey/inst.svg" alt=""></a>
                        <a href=""><img src="icons/hockey/teleg.svg" alt=""></a>
                        <a href=""><img src="icons/hockey/whats.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
